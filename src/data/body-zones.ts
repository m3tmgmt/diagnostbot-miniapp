...
// ViewBox: 0 0 200 400
// Скопировано из masterbot-miniapp/src/data/body-zones.ts

import type { IBodyZoneDefinition } from '../types/diagnostics';

// ═══════════════════════════════════════════════════════════════
// УТИЛИТЫ — цвет и прозрачность по интенсивности
// ═══════════════════════════════════════════════════════════════

/** Цвет по интенсивности (0-10): зелёный → жёлтый → оранжевый → красный */
